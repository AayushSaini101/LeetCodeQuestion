...
## Easy
<div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">For a given number <strong>N</strong> check if it is prime or not. A prime number is a number that is only<strong> divisible by 1 and itself</strong>.</span><br>
&nbsp;</p>
